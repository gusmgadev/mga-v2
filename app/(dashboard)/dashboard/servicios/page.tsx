...
export default async function ServiciosPage({
  ...
  const efectivaFechaDesde = fecha_desde ?? firstOfMonth
  ...
  if (efectivaFechaDesde) query = query.gte('fecha', efectivaFechaDesde)
  ...
  return (
    <ServiciosClient
      ...
      clientes={clientes}
      activos={activos}
      filtros={{ cliente_id: cliente_id ? Number(cliente_id) : null, estado: estado ?? null, estado_pago: estado_pago ?? null, fecha_desde: efectivaFechaDesde, fecha_hasta: fecha_hasta ?? null }}
      permisos={permisos}
    />
  )
}
