    ...
    <>
      ...
      {showCreate && (
        <ModalOverlay onClose={() => setShowCreate(false)}>
          <ModalCard title="Nueva noticia" onClose={() => setShowCreate(false)} formId="create-form">
      ...
      {editTarget && (
        <ModalOverlay onClose={() => setEditTarget(null)}>
          <ModalCard title="Editar noticia" onClose={() => setEditTarget(null)} formId="edit-form">
