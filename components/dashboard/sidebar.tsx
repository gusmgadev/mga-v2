...
const navItems = [
  ...
  { label: 'Servicios', href: '/dashboard/servicios', icon: Wrench, adminOnly: false },
  { label: 'Presupuestos', href: '/dashboard/presupuestos', icon: FileText, adminOnly: false },
  { label: 'Cobranzas', href: '/dashboard/cobranzas', icon: Banknote, adminOnly: false },
  { label: 'Productos', href: '/dashboard/productos', icon: Package2, adminOnly: false },
  { label: 'Remitos', href: '/dashboard/remitos', icon: ClipboardList, adminOnly: false },
  { label: 'Noticias', href: '/dashboard/noticias', icon: Newspaper, adminOnly: false },
  { label: 'Oportunidades', href: '/dashboard/oportunidades', icon: Mail, adminOnly: false },
