    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-base max-w-2xl mx-auto" style={{ color: theme.colors.textMuted }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {noticias.map((n) => (
            ...
            >
              ...
              >
                {/* Imagen */}
                <div className="relative w-full" style={{ aspectRatio: "16/7", overflow: "hidden", backgroundColor: "#E8ECF0" }}>
                  {n.imagen_card ? (
                    <Image
                      src={n.imagen_card}
                      alt={n.titulo}
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  >
                    Leer más <ArrowRight size={12} style={{ transition: "transform 0.2s ease", transform: hoveredId === n.id ? "translateX(3px)" : "none" }} />
                  </div>
                </div>
              </article>
            </Link>
